...
import com.aaron.toolsaaron.utils.ScreenUtil;

public class PickViewPager extends ViewPager implements View.OnClickListener {
    ...
    public static final String TAG = "PickViewPager";
    ...
    public PickViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//                BaseFragmentPagerAdapter adapter = ((BaseFragmentPagerAdapter) getAdapter());
//                PhotoView mImage = (PhotoView) adapter.getItem(getCurrentItem()).getView().findViewById(R.id.photoview);
//                switch (ev.getAction()){
