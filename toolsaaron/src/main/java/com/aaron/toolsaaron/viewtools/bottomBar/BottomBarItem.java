package com.aaron.toolsaaron.viewtools.bottomBar;
...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, UIUtils.sp2px(mTextSize));
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, UIUtils.dip2Px(mMarginTop));
        ...
        mUnreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, UIUtils.sp2px(mUnreadTextSize));
        ...
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, UIUtils.sp2px(mMsgTextSize));
     ...
     * 设置未读数
     *
     * @param unreadNum 小于等于{@link com.aaron.toolsaaron.viewtools.bottomBar.BottomBarItem#unreadNumThreshold}则隐藏，
     *                  大于0小于{@link com.aaron.toolsaaron.viewtools.bottomBar.BottomBarItem#unreadNumThreshold}则显示对应数字，
     *                  超过{@link com.aaron.toolsaaron.viewtools.bottomBar.BottomBarItem#unreadNumThreshold}
     *                  显示{@link com.aaron.toolsaaron.viewtools.bottomBar.BottomBarItem#unreadNumThreshold}+
     */
